...
BBEnumMap::BBEnumMap()
{
	...
	addEnumItem("ContactTag::GHOST_TOUCH", ContactTag::GHOST_TOUCH);
	...
	addEnumItem("BB_ENVIRONMENT_COMPONENT", ComponentTypes::BB_ENVIRONMENT_COMPONENT);
	addEnumItem("BB_GHOST_BRAIN_COMPONENT", ComponentTypes::BB_GHOST_BRAIN_COMPONENT);
	...
	addEnumItem("Actions::MOVE", Actions::MOVE);
	addEnumItem("Actions::GHOST_DOOR_ENTER", Actions::GHOST_DOOR_ENTER);
