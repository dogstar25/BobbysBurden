...
bool IndianStatuePuzzle::isPuzzlePieceApplicable(GameObject* puzzlePieceObject)
{
...
void IndianStatuePuzzle::applyPuzzlePiece(GameObject* puzzleObject, GameObject* puzzlePieceObject)
{
